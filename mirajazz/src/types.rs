...
pub enum DeviceInput {
    ...
    /// Individual button pressed
    ButtonDown(u8),
    /// Individual button released
    ButtonUp(u8),

    /// Individual encoder pressed
    EncoderDown(u8),
    /// Individual encoder released
    EncoderUp(u8),

    /// Individual encoder twisted
    SingleEncoderTwist(u8, i8),
}
